...
function User() {
    ...
    useEffect(() => {
        ...
        getReposData(params.login)
    }, [params.login]);

    // Get user profile information and github repos.
    ...
    return (
        <>
            <div className='w-full mx-auto w-10/12'>
                <div className='mb-4'>
                ...
                <div className='w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 bg-gray-900 stats'>
                    <div className='stat '>
